...
import { useGlobalState, useGlobalStateBatch, useGlobalStateReadOnly, getGlobalState, initGlobalState, removeGlobalState } from "globalstate";

const TITLE = "Update filter / Select field";
const DESC = <>
...
const InputComponent = (props: {
	...
	const [fieldValue, setFieldValue] = useGlobalState<string>({
		fullQualifiedName: `form_values.${fieldName}`, // base state object for the selectors
		defaultState: "",
		subscriberId: scope,
		updateFilter: { compareState: true }
	});
...
const ReadOnlyComponent = (props: {
	...
	const fieldValue = useGlobalStateReadOnly<string>({
